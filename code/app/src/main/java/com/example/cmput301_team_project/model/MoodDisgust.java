...
public class MoodDisgust extends Mood{
    ...
    /**
     * Returns the Mood's emotion (disgust), overrides the base Moods getEmotion() method.
     *
    ...
    /**
     * Gets the Mood's emoji (disgust), overrides the base Moods getEmoji() method.
     *
    ...
    /**
     * Gets the display name of the disgusted emotion.
     *
