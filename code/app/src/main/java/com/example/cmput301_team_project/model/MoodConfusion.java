...
public class MoodConfusion extends Mood {
    ...
    /**
     * Returns the Mood's emotion (confusion), overrides the base Moods getEmotion() method.
     *
     * @return The {@link MoodEmotionEnum} representing Confusion.
     */
    @Override
    ...
    /**
     * Gets the display name of the confusion emotion.
     *
