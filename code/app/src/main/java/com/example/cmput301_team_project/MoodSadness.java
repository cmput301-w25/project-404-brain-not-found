...
public class MoodSadness extends Mood {
    ...
    public MoodSadness(MoodSocialSituationEnum socialSituation, String trigger, String location) {
    ...
    public MoodSadness(MoodSocialSituationEnum socialSituation, String trigger, Date date, String location) {
