...
public class MoodDisgust extends Mood{
    public MoodDisgust(MoodSocialSituationEnum socialSituation, String trigger, String imageBase64) {
        super(socialSituation, trigger, imageBase64);
    }

    public MoodDisgust(MoodSocialSituationEnum socialSituation, String trigger, Date date, String imageBase64) {
