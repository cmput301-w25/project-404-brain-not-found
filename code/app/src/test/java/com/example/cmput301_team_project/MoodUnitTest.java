...
public class MoodUnitTest {
    ...
    public void testCreateMood() {
        class TestHelper {
            Mood createMoodUtil(MoodEmotionEnum emotion) {
                return Mood.createMood(emotion, MoodSocialSituationEnum.ALONE, "", "", null, null, null);
            }
        }
    ...
    public void testIllegalCreateMood() {
        assertThrows(IllegalArgumentException.class, () -> {
            Mood.createMood(MoodEmotionEnum.NONE, MoodSocialSituationEnum.ALONE, "", "", null, null, null);
        });
    }
}
